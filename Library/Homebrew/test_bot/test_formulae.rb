  ...
  module TestBot
    class TestFormulae < Test
      ...
      def initialize(tap:, git:, dry_run:, fail_fast:, verbose:)
        ...
        @skip_candidates = T.let([], T::Array[String])
        ...
        @tested_dependents_list = T.let(Pathname.new("tested-dependents-placeholder.txt"), Pathname)
      end
      ...
      sig { params(formula: Formula, built_formulae: T::Array[String], no_older_versions: T::Boolean).returns(T::Boolean) }
